...
import { createMasteryTopic, generateMasteryTopicDraftCompatible, type MasteryTopic, type StructuredTopicDraftInput, type TopicDraft, type TopicSourceInput } from "@/lib/learning-api";
...
export default function NewMasteryPathPage() {
  ...
  const generate = async (must_cover: string[] = []) => {
    const values: MasteryPathFormValues = { name, goal, learningPurpose, customPurpose, level, knownTopics, skippedTopics, scopeMode, scopeInclude, scopeExclude, approach, granularity, rigor, activities, timeMode, weeklyHours, durationWeeks, deadline, sessionMinutes, milestonePreference, milestones };
